...
case_types = ['PI', 'PD']
mod_types = ['OsloAeroSec','OsloAeroSec$_{elvoc}$','OsloAeroSec$_{svoc}$','OsloAero$_{imp}$','OsloAero$_{def}$'][::-1]
mod_types = ['OsloAeroSec','OsloAeroSec$_{elvoc}$','OsloAeroSec$_{svoc}$']
