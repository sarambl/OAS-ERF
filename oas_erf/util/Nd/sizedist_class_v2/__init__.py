...
import oas_erf.util.eusaar_data.distc_var as distc_var
...
varListNorESM = oas_erf.data_info.variable_info.sized_varListNorESM
...
class Sizedistribution:
    ...
    def __init__(self,
                 ...
                 chunks={'diameter': 20}, use_pressure_coords=True,
