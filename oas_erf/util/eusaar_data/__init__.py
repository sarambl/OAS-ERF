...
from oas_erf.constants import path_eusaar_data, path_eusaar_outdata  # path_eusaar_data
from oas_erf.constants import project_base_path
import numpy as np
# %%
...
station_table_path =project_base_path + 'oas_erf/oas_erf/misc/eusaar_table2_asmi2011.csv'
...
def plot_res_season(ddic, sec, typ='quan', axs=None, figsize=[7,7]):
    """
    author: aliaga daliaga_at_chacaltaya.edu.bo
    :param ddic:
    :param sec:
...
# %%
from oas_erf.constants import collocate_locations
...
def get_ordered_stations(cat=dall_c, sorter = sorter):
