...
from oas_erf.constants import get_outdata_path
from oas_erf.util.eusaar_data import subs_codes as subset_codes_eusaar
from oas_erf.util.eusaar_data.distc_var import percs_in_eusaar_files
from oas_erf.util.eusaar_data.flags import make_data_flags
