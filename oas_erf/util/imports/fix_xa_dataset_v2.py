...
def xr_fix(dtset, model_name='NorESM', comp='atm'):
    ...
    if model_name == 'NorESM':
        ...
        NCONC_noresm = oas_erf.data_info.variable_info.sized_varListNorESM['NCONC']
        ...
        NMR_noresm = oas_erf.data_info.variable_info.sized_varListNorESM['NMR']
...
def _ch_unit(dtset, typ, var):
    fac = oas_erf.data_info.variable_info.default_units[typ]['factor']
    un = oas_erf.data_info.variable_info.default_units[typ]['units']
    exceptions = oas_erf.data_info.variable_info.default_units[typ]['exceptions']
