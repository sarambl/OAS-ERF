import oas_erf.util.slice_average.avg_pkg as avg_pkg
import oas_erf.util.imports.get_pressure_coord_fields
from oas_erf.util.slice_average.avg_pkg import maps
import oas_erf.util.slice_average.avg_pkg.levlat
import oas_erf.util.slice_average.avg_pkg.one_value
import oas_erf.util.slice_average.avg_pkg.profiles
...
from oas_erf.constants import get_input_datapath
...
def get_area_avg_nested(models, cases, varlist, area, from_time, to_time,
    ...
    for model in models:
        ...
        for case in cases:
            ...
            for var in varlist:
                # Check if data already calculated:
                ds_avg, var_loaded = oas_erf.util.slice_average.avg_pkg.one_value.load_area_file_var(model,
                                                                                                       case,
                                                                                                       var,
                                                                                                       area,
                                                                                                       from_time,
                ...
                if not var_loaded:
                    ...
                    ds_avg = oas_erf.util.slice_average.avg_pkg.one_value.get_average_area(dummy,
                                                                                             [var], case,
                                                                                             area, from_time,
                                                                                             to_time, model, pmin,
