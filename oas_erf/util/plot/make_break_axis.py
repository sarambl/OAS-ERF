...
def make_my_grid_subplots(ratios_c, ratios_r, gridspec_kwargs = {'wspace':0.2, 'hspace':0.2, 'left':.2, 'top':0.9}):
...
def _make_grid_subplots(ratios_c, ratios_r, gridspec_kwargs={},
