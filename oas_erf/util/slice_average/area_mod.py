...
def get_4d_area_mask(area, dtset, lev, test_var, time):
    """
    Returns True in mask, False for designated ares. Returns 4D area mask for area and dtset using test_var for dimensions.
